...
<div class="container">
    ...
    <div class="col-lg-12 clearfix">
        ...
        <h2>Ateneos / Ateneo Clínico Multidisciplinario 2018</h2>
        <div class="barra"></div>
            <div class="container-fluid">
                <div class="row">

                <section>
                <a href="{{asset('assets/frontend/images/album/ateneos/ateneo-multidisciplinario-18/portada-2.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/ateneos/ateneo-multidisciplinario-18/portada-2.jpg')}}"></div></a>
                    @for ($i = 1; $i < 7; $i++)
                            <a href="{{asset('assets/frontend/images/album/ateneos/ateneo-multidisciplinario-18/'.$i.'.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/ateneos/ateneo-multidisciplinario-18/'.$i.'.jpg')}}"></div></a>
                    @endfor
                <section>
