...
<div class="container">
    ...
    <div class="col-lg-12 clearfix">
        ...
        <a href="{{ route('ateneos_2018') }}"><div class="col-md-2 articulo"><h1>ATENEOS INTERRESIDENCIA 2018</h1></div></a>

        <div class="segundo col-lg-12 rigth">
        <h2>Ateneos / Ateneo Neurocirugia 2018</h2>
        <div class="barra"></div>
            <div class="container-fluid">
                <div class="row">
                ...
                <section>
                    @for ($i = 1; $i < 5; $i++)
                            <a href="{{asset('assets/frontend/images/album/ateneos/ateneo-neurocirugia-18/'.$i.'.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/ateneos/ateneo-neurocirugia-18/'.$i.'.jpg')}}"></div></a>
                    @endfor
                <section>
