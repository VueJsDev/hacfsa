...
<div class="container">
    ...
    <div class="col-lg-12 clearfix">
       ...
       <div class="segundo col-lg-12 rigth">
          <h2>Ateneos / Ateneo Terapia Intensiva</h2>
          <div class="barra"></div>
              <div class="container-fluid">
                <div class="row">
                ...
                <section>
                 ...
                 <a href="{{asset('assets/frontend/images/album/ateneos/ateneointer/1.JPG')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/ateneos/ateneointer/1.JPG')}}"></div></a>

                 <a href="{{asset('assets/frontend/images/album/ateneos/ateneointer/2.JPG')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/ateneos/ateneointer/2.JPG')}}"></div></a>

                 <a href="{{asset('assets/frontend/images/album/ateneos/ateneointer/3.JPG')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/ateneos/ateneointer/3.JPG')}}"></div></a>
