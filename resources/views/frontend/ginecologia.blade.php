...
<div class="container">
    ...
    <div class="col-lg-12 clearfix">
       ...
       <div class="segundo col-lg-12 rigth">
          <h2>Jornadas / Jornada de Ginecología 2017</h2>
          <div class="barra"></div>
              <div class="container-fluid">
                <div class="row">
                  ...
                  <section>
                     ...
                     <a href="{{asset('assets/frontend/images/album/simposios/jornadas-ginecologia/afiche-ginecologia.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/simposios/jornadas-ginecologia/afiche-ginecologia.jpg')}}"></div></a>


                     @for ($i = 1; $i < 38; $i++)
                        <a href="{{asset('assets/frontend/images/album/simposios/jornadas-ginecologia/'.$i.'.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/simposios/jornadas-ginecologia/'.$i.'.jpg')}}"></div></a>
                    @endfor
