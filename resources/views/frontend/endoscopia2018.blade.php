...
<div class="container">
      ...
      <div class="col-lg-12 clearfix">
         ...
         <div class="segundo col-lg-12 rigth">
            <h2>Jornadas / Jornada de Endoscopía 2018</h2>
            <div class="barra"></div>
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <section>
                       ...
                       <a href="{{ asset('assets/frontend/images/album/simposios/jornada-endoscopia-2018/aficheEndoscopia2018.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/simposios/jornada-endoscopia-2018/aficheEndoscopia2018.jpg')}}"></div></a>
                        @for ($i = 1; $i < 9; $i++)
                          <a href="{{asset('assets/frontend/images/album/simposios/jornada-endoscopia-2018/'.$i.'.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/simposios/jornada-endoscopia-2018/'.$i.'.jpg')}}"></div></a>
                        @endfor
