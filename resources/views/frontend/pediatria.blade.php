          ...
          <div class="barra"></div>
              <div class="container-fluid">
                <div class="row">
                  ...
                  <section>
                    <a href="{{asset('assets/frontend/images/album/simposios/jornadas-pediatria/afiche-pediatria.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/simposios/jornadas-pediatria/afiche-pediatria.jpg')}}"></div></a>
                     @for ($i = 1; $i < 32; $i++)
                        <a href="{{asset('assets/frontend/images/album/simposios/jornadas-pediatria/'.$i.'.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/simposios/jornadas-pediatria/'.$i.'.jpg')}}"></div></a>
                    @endfor
                  </section>
