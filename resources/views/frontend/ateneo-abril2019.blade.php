...
<div class="container">
    ...
    <div class="col-lg-12 clearfix">
       ...
       <div class="segundo col-lg-12 rigth">
          <h2>Ateneos / Ateneo Abril 2019</h2>
          <div class="barra"></div>
              <div class="container-fluid">
                <div class="row">
                ...
                <section>
                    @for ($i = 1; $i < 4; $i++)
                        <a href="{{asset('assets/frontend/images/album/ateneos/ateneo-abril-19/'.$i.'.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/ateneos/ateneo-abril-19/'.$i.'.jpg')}}"></div></a>
                    @endfor
                 <section>
