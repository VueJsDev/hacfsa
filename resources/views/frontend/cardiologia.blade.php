...
<div class="container">
    ...
    <div class="col-lg-12 clearfix">
       ...
       <div class="segundo col-lg-12 rigth">
          <h2>Simposios / Simposio de Cardiología 2017</h2>
          <div class="barra"></div>
              <div class="container-fluid">
                <div class="row">

                  <section>
                    <a href="{{asset('assets/frontend/images/album/simposios/simposio-cardiologia/afiche-cardiologia-2017.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/simposios/simposio-cardiologia/afiche-cardiologia-2017.jpg')}}"></div></a>
                    @for ($i = 1; $i < 38; $i++)
                        <a href="{{asset('assets/frontend/images/album/simposios/simposio-cardiologia/'.$i.'.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/simposios/simposio-cardiologia/'.$i.'.jpg')}}"></div></a>
                    @endfor
