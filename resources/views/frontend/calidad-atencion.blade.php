...
<div class="container">
    ...
    <div class="col-lg-12 clearfix">
       ...
       <h2>Taller sobre Mejora en Calidad de Atención</h2>
          <div class="barra"></div>
              <div class="container-fluid">
                <div class="row">
                  ...
                  <section>
                     @for ($i = 1; $i < 5; $i++)
                    <a href="{{asset('assets/frontend/images/album/charlas/taller-calidadeatencion/'.$i.'.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/charlas/taller-calidadeatencion/'.$i.'.jpg')}}"></div></a>
                    @endfor
                  </section>
