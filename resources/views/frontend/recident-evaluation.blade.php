                ...
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <section>
                      @for ($i = 1; $i < 59; $i++)
                          @if($i != 24)
                            <a href="{{asset('assets/frontend/images/album/residencias/examen2018/'.$i.'.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/residencias/examen2018/'.$i.'.jpg')}}"></div></a>
                          @endif                     
                      @endfor
                    </section>
