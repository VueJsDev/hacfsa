...
<div class="container">
    ...
    <div class="col-lg-12 clearfix">
       ...
       <h2>Jornadas / Jornada de Kinesiología 2018</h2>
          <div class="barra"></div>
              <div class="container-fluid">
                <div class="row">

                  <section>
                    <a href="{{asset('assets/frontend/images/album/simposios/jornada-kinesiologia-2018/afiche-kinesiologia-2018.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/simposios/jornada-kinesiologia-2018/afiche-kinesiologia-2018.jpg')}}"></div></a>
                     @for ($i = 1; $i < 20; $i++)
                    <a href="{{asset('assets/frontend/images/album/simposios/jornada-kinesiologia-2018/'.$i.'.jpg')}}" data-lightbox="example-1"><div class="col-md-3 thumbnail album"><img src="{{asset('assets/frontend/images/album/simposios/jornada-kinesiologia-2018/'.$i.'.jpg')}}"></div></a>
                    @endfor
                  </section>
